...
table3_reg1 = read.csv("RegressionsResults/table3_reg1.csv") %>%
  tibble() %>%
  subset(select = -1)
table3_reg2 = read.csv("RegressionsResults/table3_reg2.csv") %>%
  tibble() %>%
  subset(select = -1)
table3_reg3 = read.csv("RegressionsResults/table3_reg3.csv") %>%
  tibble() %>%
  subset(select = -1)
table3_reg4 = read.csv("RegressionsResults/table3_reg4.csv") %>%
  tibble() %>%
  subset(select = -1)
table3_reg5 = read.csv("RegressionsResults/table3_reg5.csv") %>%
  tibble() %>%
  subset(select = -1)
table3_reg6 = read.csv("RegressionsResults/table3_reg6.csv") %>%
  tibble() %>%
  subset(select = -1)
