...
table5_reg1 = read.csv("RegressionsResults/table5_reg1.csv") %>%
  tibble() %>%
  subset(select = -1)
table5_reg2 = read.csv("RegressionsResults/table5_reg2.csv") %>%
  tibble() %>%
  subset(select = -1)
table5_reg3 = read.csv("RegressionsResults/table5_reg3.csv") %>%
  tibble() %>%
  subset(select = -1)
table5_reg4 = read.csv("RegressionsResults/table5_reg4.csv") %>%
  tibble() %>%
  subset(select = -1)
table5_reg5 = read.csv("RegressionsResults/table5_reg5.csv") %>%
  tibble() %>%
  subset(select = -1)
table5_reg6 = read.csv("RegressionsResults/table5_reg6.csv") %>%
  tibble() %>%
  subset(select = -1)
table5_reg7 = read.csv("RegressionsResults/table5_reg7.csv") %>%
  tibble() %>%
  subset(select = -1)
table5_reg8 = read.csv("RegressionsResults/table5_reg8.csv") %>%
  tibble() %>%
  subset(select = -1)
...
table5_gt
gtsave(table5_gt, "FinalTables/table5.html")
