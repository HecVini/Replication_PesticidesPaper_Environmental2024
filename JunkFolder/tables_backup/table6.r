...
table6_reg1 = read.csv("RegressionsResults/table6_reg1.csv") %>%
  tibble() %>%
  subset(select = -1)
table6_reg2 = read.csv("RegressionsResults/table6_reg2.csv") %>%
  tibble() %>%
  subset(select = -1)
table6_reg3 = read.csv("RegressionsResults/table6_reg3.csv") %>%
  tibble() %>%
  subset(select = -1)
table6_reg4 = read.csv("RegressionsResults/table6_reg4.csv") %>%
  tibble() %>%
  subset(select = -1)
table6_reg5 = read.csv("RegressionsResults/table6_reg5.csv") %>%
  tibble() %>%
  subset(select = -1)
table6_reg6 = read.csv("RegressionsResults/table6_reg6.csv") %>%
  tibble() %>%
  subset(select = -1)
table6_reg7 = read.csv("RegressionsResults/table6_reg7.csv") %>%
  tibble() %>%
  subset(select = -1)
...
table6_gt <- table6_gt %>%
  cols_label(
    ...
    estimate_3 = md("**Model 3:** <br> Pregnancy Output"),
    estimate_4 = md("**Model 4:** <br> Prenatal Controls"),
    estimate_5 = md("**Model 5:** <br> I(Education)"),
    estimate_6 = md("**Model 6:** <br> I(Born at Private Hospital)"),
    estimate_7 = md("**Model 7:** <br> I(Normal Labor)")
  )
