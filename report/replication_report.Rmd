...
Firstly, here is the setup used for the replication of the regressions:
...
Secondly, we've created some useful functions. These functions will be called on the regression codes.
...
COMENTAR ESSE PRIMEIRO BLOCO DE FUNÇÕES -- EXPLICAR INTUICAO/O Q FAZ
...
For the boostrap, here is the function created:
...
```
COMENTAR ESSE  BLOCO DE FUNÇÕES -- EXPLICAR INTUICAO/O Q FAZ
EXPLICAR QUE EM CIMA COLOCOU N0_BOOTSTRAP=100 POR LIMITE COMPUTACIONAL


Finally, the last function that returns the estimations results:
...
DETALHE IMP: VEJA QUE AQUI COLOQUEI O CLUST NO GRID NA TABELA 5- NAO SEI COMO FICOU SEU CODIGO VERSÃO FINAL --- alterar aqui se mudou :)
EXPLICAR PORQUE MUDOU O CLUSTER POR CONTA DE LIMITE (mas MOSTRAR que estimativa pontual é identica)
