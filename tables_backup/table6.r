...
table6_gt <- table6_gt %>%
  cols_label(
    coef = "",
    estimate_1 = md("**Model 1:** <br> No. Labors"),
    estimate_2 = md("**Model 2:** <br> No. Children"),
    estimate_3 = md("**Model 3:** <br> No. Pregnancy Output"),
    estimate_4 = md("**Model 4:** <br> No. Prenatal Controls"),
    estimate_5 = md("**Model 5:** <br> No. Education"),
    estimate_6 = md("**Model 6:** <br> No. Private Hospital"),
    estimate_7 = md("**Model 7:** <br> No. Birth Type")
  )
